...
class embedded_gaussian(nn.Module):
    def __init__(self, g, theta, phi, W, inter_channels):
        super(embedded_gaussian, self).__init__()
        self.g = g
        self.theta = theta
        self.phi = phi
        self.W = W
    ...
    def __init__(self, in_channels, inter_channels=None, dimension=3, mode='embedded_gaussian',
        ...
        if mode in ['embedded_gaussian', 'dot_product', 'concatenation']:
            ...
            if mode == 'embedded_gaussian':
                ...
                self.operation_function = embedded_gaussian(self.g, self.theta, self.phi, self.W, self.inter_channels)
