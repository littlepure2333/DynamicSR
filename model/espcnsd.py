...
class ESPCN(nn.Module):
    ...
    def __init__(self, args):
        ...
        dilation = 2
        self.pre_conv1 = common.ShareSepConv(dilation * 2 - 1)
        self.conv1 = nn.Conv2d(self.n_colors, 64, (3, 3), stride=1, padding=dilation, dilation=dilation)
        self.pre_conv2 = common.ShareSepConv(dilation * 2 - 1)
        self.conv2 = nn.Conv2d(64, 64, (3, 3), (1, 1), padding=dilation, dilation=dilation)
        self.pre_conv3 = common.ShareSepConv(dilation * 2 - 1)
        self.conv3 = nn.Conv2d(64, 32, (3, 3), (1, 1), padding=dilation, dilation=dilation)
    ...
    def forward(self, x, krl=None):
        # (x, krl)
        out = self.act_func(self.conv1(self.pre_conv1(x)))
        out = self.act_func(self.conv2(self.pre_conv2(out)))
        out = self.act_func(self.conv3(self.pre_conv3(out)))
