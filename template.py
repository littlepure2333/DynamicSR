...
def set_template(args):
    ...
    if args.template.find('EDSR_efficient') >= 0:
        ...
        args.save = "{}_{}_efficient_x{}_e{}_ps{}_lr{}_n{}_i{}_s{}".format(today, args.model, args.scale, args.epochs, args.patch_size, args.lr, args.n_resblocks, args.exit_interval, args.shared_tail)
    ...
    if args.template.find('EDSR_dynamic') >= 0:
        ...
        args.save_gt = False
        args.dynamic = True
        args.save = "{}_{}_x{}_e{}_ps{}_lr{}_only_last".format(today, args.model, args.scale, args.epochs, args.patch_size, args.lr)
